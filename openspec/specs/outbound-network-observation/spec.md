# outbound-network-observation Specification

## Purpose

Defines privacy-bounded outbound connection-attempt observation and safe investigation across capture, storage, APIs, and Web UI.
