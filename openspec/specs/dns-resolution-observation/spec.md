# dns-resolution-observation Specification

## Purpose

Defines privacy-bounded plaintext DNS capture, typed evidence, qualified DNS-to-connection correlation, and reproducible deployed acceptance.
